# Skill Session: Technosphere and Ecosphere — Polyester T-shirt
**Skill:** technosphere-and-ecosphere v0.1
**Case study:** polyester_tshirt
**Date:** 2026-06-15
...
Two substances are emitted from this supply chain into the natural world:
- **Carbon dioxide** — released to air at all three stages: the oil well, the fiber plant, and the garment factory.
- **Methane** — released to air at the oil well only, as a fugitive leak (meaning it escapes from pipelines and equipment, rather than being burned deliberately).
...
- Student correctly identified chimney smoke on the first try (with a small typo — "chimeny") — the town-wall analogy landed immediately, same as the wool_yarn session.
- Student correctly guessed CO₂ as the bigger contributor — unlike wool_yarn where methane dominated, polyester_tshirt is CO₂-dominated because it appears at all three stages. This contrast between the two case studies is a valuable teaching moment.
- Student immediately and correctly identified that switching to solar panels changes the ecosphere crossings, not the technosphere processes — a sharp answer that shows solid grasp of the two-worlds model.
- Session completed all five steps cleanly in four exchanges.
- Natural next skill to offer: **characterisation** — the student is primed to ask how CO₂ and methane get combined into a single impact score.
- Contrast with wool_yarn session: in wool_yarn the surprising answer was methane; here the intuitive answer (CO₂) was correct. Running both case studies back-to-back reinforces that you always have to look at the specific crossings rather than assuming one gas is always dominant.
