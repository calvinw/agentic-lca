---
name: Levi's 501 Jeans — wash every 2 wears (Group 1, Scenario B)
goal: >
  Reproduce the Levi's 2015 LCA consumer care scenario where the consumer
  washes their jeans once every 2 times they wear them. This is close to
  the US average (which is every 2.3 wears). US consumer, conventional
  washing machine, average mix of cold/warm water and tumble dry.
  Based on Levi Strauss & Co.'s 2015 LCA study.

functional_unit:
  description: One pair of Levi's 501 jeans — full lifecycle, wash every 2 wears
  amount: 1.0
  unit: pair
...
Group 1, Scenario B — wash every 2 wears (close to US average of 2.3).

Consumer care CO₂ from the Levi's PDF: 15.38 kg.
P4 electricity = 15.38 / 0.5 = 30.76 kWh.
Expected full lifecycle total: ~36.3 kg CO₂.
