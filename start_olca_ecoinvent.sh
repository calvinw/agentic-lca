...
# Starts the openLCA gdt-server pointed at the ecoinvent database.
# Use this instead of start_olca.sh when an ecoinvent license is available.
#
# Usage:  bash start_olca_ecoinvent.sh
